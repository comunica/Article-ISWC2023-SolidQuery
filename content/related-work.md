...
as a way to query over the Web of Linked Open Data as if it was a globally distributed dataspace,
...
While LTQP considers the Web of Linked Open Data a large database using the RDF data model,
...
In addition to filtering links via different semantics,
...
In contrast,
our work applies LTQP to decentralized environments with *private* personal data,
organized in personal data vaults with specific structural properties.
